...
@section('container')
<a href="{{ route('admin.mutasi.create') }}" class="btn btn-primary mb-3">Tambah Mutasi</a>

<!-- Filter Form -->
<form action="{{ route('admin.mutasi.index') }}" method="GET" class="mb-3">
    <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('admin.mutasi.index') }}" class="btn btn-secondary ml-2">Reset</a>
        </div>
    </div>
</form>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $mutasi->id }}">
                            <li><a class="dropdown-item detail-button" href="{{ route('admin.mutasi.show', $mutasi) }}">Detail</a></li>
                        ...
                        <form action="{{ route('admin.mutasi.destroy', $mutasi) }}" method="post" class="delete-form"
                            style="display: none;">
                            @csrf
                            @method('delete')
...
<script>
    $(document).ready(function () {
        ...
        $('.edit-button').on('click', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            var url = "{{ route('admin.mutasi.edit', ':id') }}";
        ...
        $('.delete-button').on('click', function (e) {
            ...
            var url = "{{ route('admin.mutasi.destroy', ':id') }}";
            url = url.replace(':id', id);
