<form action="{{ route('suratJalan.storeDetail') }}" method="post" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="card card-plain">
                        ...
                        <div class="card-body pb-3">
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="btn bg-gradient-primary btn-lg btn-rounded w-100 mt-4 mb-0">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
